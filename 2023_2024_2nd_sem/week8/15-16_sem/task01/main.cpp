...
int print_data(std::vector<int> sales) {
    std::cout << "Total sales volume for the year: " << pt1 << '\n';
    std::cout << "Month with maximum sales volume: " << pt2 << '\n';
    std::cout << "Average monthly sales: " << pt3 << '\n';
    std::cout << "Month with maximum sales volume: " << vac_to_string(sales) << '\n';
